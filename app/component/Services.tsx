const Services = () => {
  return (
    <div className="px-4 py-20 mx-auto max-w-7xl">
      ...
      <div className="grid grid-cols-1 gap-x-4 gap-y-6 lg:gap-x-8 lg:gap-y-8 md:grid-cols-2 lg:grid-cols-3 mb-4">
        <div className="w-full p-8 mb-5 text-center transition-all bg-white rounded shadow  hover:shadow-lg">
          ...
          <h3 className="mb-4 text-2xl font-semibold "> Self Fixing Cogs </h3>
